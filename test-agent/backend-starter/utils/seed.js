...
// Seed function
async function seedDatabase(uri = MONGODB_URI, closeConnection = true) {
  try {
    // Connect to MongoDB
    ...
    // Close MongoDB connection if requested
    if (closeConnection) {
      await mongoose.connection.close();
      console.log('MongoDB connection closed in seed script');
    }
  }
}
